...
<img src="https://img.shields.io/badge/streamlit-FF4B4B?style=flat-square&logo=streamlit&logoColor=A8B9CC"/> : https://traffic-accident.streamlit.app/         
...
교통사고 가해 운전자 연령별 시간대별 교통사고 발생 건수를 분석한 결과 **51세에서 64세 운전자**는 다른 연령대와 동일하게 출퇴근 시간에 **사고가 가장 많이 발생**했으나, **65세 이상 운전자**의 경우 **오전 10시 ~ 12시, 오후 2시 ~ 4시**에 정점을 찍는 것을 확인했습니다.          
